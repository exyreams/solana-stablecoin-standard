        ...
        <div className="bg-panel border border-border shadow-2xl rounded-2xl p-8 backdrop-blur-sm relative z-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-2">
              <label className="text-xs font-bold uppercase tracking-wider text-text-dark">Username</label>
            ...
            <div className="space-y-2">
              <label className="text-xs font-bold uppercase tracking-wider text-text-dark">Password</label>
              <div className="relative">
            ...
            <div className="space-y-2">
              <label className="text-xs font-bold uppercase tracking-wider text-text-dark">Registration Secret</label>
              <div className="relative">
              ...
              <p className="text-[10px] text-text-dark italic">Found in your backend .env file</p>
            </div>
          ...
          <p className="mt-8 text-center text-sm text-text-dim">
            Have an account? <Link to="/login" className="text-primary hover:underline font-bold">Sign in</Link>
          </p>
        </div>
      </motion.div>
    </div>
