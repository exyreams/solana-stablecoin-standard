        ...
        <div className="bg-(--bg-surface) border border-(--border-mid) p-6 mb-6">
          ...
          <div className="grid grid-cols-3 gap-4 pt-4 border-t border-(--border-dim)">
            <div>
              ...
              <div className="font-mono text-[14px] text-(--text-main)">2.45100 SOL</div>
            </div>
            <div>
              <div className="font-mono text-[9px] text-(--text-dark) uppercase mb-1">
                STABLECOINS
            ...
            <div>
              ...
              <div className="font-mono text-[14px] text-(--text-main)">2.1M</div>
            </div>
          </div>
        </div>
            ...
            <table className="w-full">
              ...
              <tbody>
                {userStablecoins.map((coin) => (
                  <tr key={coin.mint} className="border-b border-(--border-dim) hover:bg-white/2">
                    <td className="px-6 py-4">
                      <div className="font-mono text-[12px] text-(--text-main) font-bold">
                        {coin.symbol}
                      </div>
                      <div className="text-[11px] text-(--text-dim)">{coin.name}</div>
                    </td>
                    ...
                    <td className="px-6 py-4 text-center">
                      <Badge variant="success">{coin.status.toUpperCase()}</Badge>
                    </td>
