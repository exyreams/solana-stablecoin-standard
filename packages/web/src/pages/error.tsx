        ...
        <div className="bg-(--bg-surface) border border-(--border-mid) mb-8">
          ...
          <div className="p-6 space-y-4">
            <div className="grid grid-cols-[140px_1fr] gap-4">
              <div className="font-mono text-[10px] text-(--text-dark) uppercase">Error Code</div>
              <div className="font-mono text-[12px] text-(--text-main)">{errorDetails.code}</div>
            </div>
            <div className="grid grid-cols-[140px_1fr] gap-4">
              <div className="font-mono text-[10px] text-(--text-dark) uppercase">Message</div>
              <div className="text-[12px] text-(--text-dim)">{errorDetails.message}</div>
            </div>
            <div className="grid grid-cols-[140px_1fr] gap-4">
              <div className="font-mono text-[10px] text-(--text-dark) uppercase">Timestamp</div>
          ...
          <div className="p-6">
            <ul className="space-y-3">
              {suggestedActions.map((action, index) => (
                <li key={index} className="flex gap-3 text-[13px] text-(--text-dim)">
