      ...
      <table className="w-full border-collapse font-mono">
        <thead>
          <tr className="border-b border-[#222222]">
            <th className="p-4 text-left text-[#777777] text-[12px]">FEATURE MATRIX</th>
        ...
        <tbody>
          {features.map((feature) => (
            ...
            >
              ...
              <td
                className={`p-3 text-[12px] ${feature.sss1 ? "text-[#22c55e]" : "text-[#444444]"
                  }`}
              >
                {feature.sss1 ? "✓" : "✕"}
              </td>
              <td
                className={`p-3 text-[12px] ${feature.sss2 ? "text-[#22c55e]" : "text-[#444444]"
                  }`}
              >
                {feature.sss2 ? "✓" : "✕"}
              </td>
              <td
                className={`p-3 text-[12px] ${feature.sss3 ? "text-[#22c55e]" : "text-[#444444]"
                  }`}
              >
                {feature.sss3 ? "✓" : "✕"}
              </td>
