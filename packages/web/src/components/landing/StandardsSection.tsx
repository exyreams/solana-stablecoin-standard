  ...
  return (
    <section className="py-[100px] px-20 max-w-[1200px] mx-auto">
      <div className="border-l-2 border-[#CCA352] pl-4 mb-12">
        <div className="font-mono text-[11px] text-[#CCA352] uppercase font-bold">CHOOSE YOUR STANDARD</div>
      ...
      <div className="grid grid-cols-3 gap-6">
        {standards.map((standard) => (
          <div
            key={standard.title}
            className={`bg-[#0f0f0f] border p-6 relative ${standard.variant === "recommended"
          ...
          >
            ...
            <h3
              className={`font-mono text-[24px] m-0 mb-1 font-bold ${standard.variant === "recommended"
                  ? "text-[#CCA352]"
                  : standard.variant === "private"
                    ? "text-[#3b82f6]"
                    : "text-[#EAEAEA]"
            ...
            <ul className="list-none p-0 m-0">
              {standard.features.map((feature, index) => (
                ...
                >
                  <span
                    className={
                      standard.variant === "private" ? "text-[#3b82f6]" : "text-[#CCA352]"
                    }
                  >
                    ✓
                  </span>{" "}
