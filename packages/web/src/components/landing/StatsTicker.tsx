...
export const StatsTicker: FC = () => {
  return (
    <div className="w-full overflow-hidden bg-[#0f0f0f] py-3 relative" style={{ borderTop: '1px solid #222222', borderBottom: '1px solid #222222' }}>
      {/* Left blur gradient */}
      ...
      <div className="flex whitespace-nowrap">
        ...
        {stats.map((stat, index) => (
          ...
          >
            {stat.label}: <span className="text-[#EAEAEA] ml-2">{stat.value}</span>
            {index < stats.length - 1 && <span className="ml-10 text-[#333333]">|</span>}
          </div>
        ))}
