...
const footerLinks = {
  ...
  resources: [
    ...
    { label: "GitHub", href: "https://github.com/superteam-brazil/solana-stablecoin-standard", external: true },
  ],
  community: [
...
export const Footer: FC = () => {
  return (
    <footer className="relative bg-(bg-panel) py-20 px-20 overflow-hidden" style={{ borderTop: '1px solid rgba(204, 163, 82, 0.4)' }}>
      ...
      <div className="relative z-10 grid grid-cols-[2fr_auto_repeat(5,1fr)] gap-8 mb-16 max-w-[1400px] mx-auto">
        ...
        {/* Operations */}
        <div>
          <h5 className="font-mono text-(text-main) m-0 mb-5 text-xs">OPERATIONS</h5>
          <ul className="list-none p-0 m-0">
        ...
        {/* Resources */}
        <div>
          <h5 className="font-mono text-(text-main) m-0 mb-5 text-xs">RESOURCES</h5>
          <ul className="list-none p-0 m-0">
      ...
      <div className="relative z-10 border-t border-(border-dim) pt-10 text-center text-[10px] text-(text-dark) mono">
        SSS MANAGER v1.0.0 // SOLANA STABLECOIN STANDARD // {new Date().getFullYear()}
      </div>
    </footer>
  );
};
