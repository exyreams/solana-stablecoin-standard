          ...
          <tbody>
            {events.map((event, idx) => (
              <tr
                ...
                className={`cursor-pointer transition-colors border-b border-(--border-dim) hover:bg-[rgba(204,163,82,0.03)] ${event.selected
              ...
              >
                ...
                <td className="px-3 py-2.5 align-middle text-right">
                  {event.amount ? (
                    <span
                      className={`font-bold ${event.amount.startsWith("+")
                          ? "text-green-400"
                          : "text-red-400"
                        }`}
                    >
                ...
                <td className="px-3 py-2.5 align-middle">
                  <div
                    className={`flex items-center gap-1.5 text-[9px] font-bold ${event.status === "success"
                        ? "text-green-400"
                        : "text-red-400"
                      }`}
                  >
